...
void write_png_signature_to_file(std::ofstream& fs, const csc::picture& image) {
...
constexpr void write_chunk_to_ofstream(std::ofstream& os, const csc::chunk& bufferized) {
