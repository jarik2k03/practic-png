...
std::ostream& operator<<(std::ostream& os, const png::picture& image) {
  ...
  const uint8_t image_bit_depth = std::get<png::IHDR>(image.m_structured[0]).bit_depth;
  ...
  auto write_section_to_ostream = png::f_write_section_to_ostream(os, image_bit_depth);
