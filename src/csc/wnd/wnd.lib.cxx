...
export void applying_tool_by_keyboard_event(
  ...
  wnd::switch_from_insert_to_normal(
      controller_obj, pngine_obj, picture_obj, is_key_on_apply_btn, is_accept_action, is_decline_action);
}
...
export void applying_tool_by_mouse_event(wnd::glfw_window* current, int button, int action, int /*mods*/) noexcept {
  ...
  wnd::switch_from_insert_to_normal(
      controller_obj, pngine_obj, picture_obj, is_mouse_on_apply_btn, is_accept_action, is_decline_action);
}
